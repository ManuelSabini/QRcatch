...
function insercionCodigo(valor, formato){
    ...
    imgCod.innerHTML = `<img src="https://barcode.tec-it.com/barcode.ashx?data=${valor}&code=${formato}&translate-esc=true&dpi=300&imagetype=Png" alt="${valor}" id="codigo">`;
    ...
    btnDescarga.innerHTML =`<button class="btn btn-outline-success btn-sm" type="button" onclick="DescargarQR()">
...
function DescargarQR(){
    imgURL = document.querySelector("#codigo").src;
    descarga = document.createElement("a");
    descarga.href = imgURL;
    descarga.download = document.querySelector("#codigo").alt+".png";
    descarga.click();
}
